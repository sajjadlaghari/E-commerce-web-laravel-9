                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="{{ route('fashion') }}">Buy Now</a></div>
                                            <div class="seemore_bt"><a href="{{ route('fashion') }}">See More</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="{{ route('electronics') }}">Buy Now</a></div>
                                            <div class="seemore_bt"><a href="{{ route('electronics') }}">See More</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-4">
                                    <div class="box_main">
                                        ...
                                        <div class="btn_main">
                                            <div class="buy_bt"><a href="{{ route('jewellery') }}">Buy Now</a></div>
                                            <div class="seemore_bt"><a href="{{ route('jewellery') }}">See More</a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-4">
